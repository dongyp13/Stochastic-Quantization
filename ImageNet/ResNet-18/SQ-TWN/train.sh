...
$TOOLS/caffe train \
	...
	--weights=model/resnet18_SQTWN_s1_iter_300000.caffemodel

$TOOLS/caffe train \
	--solver=solver_s3.prototxt -gpu 0 \
	--weights=model/resnet18_SQTWN_s2_iter_300000.caffemodel

$TOOLS/caffe train \
	--solver=solver_s4.prototxt -gpu 0 \
	--weights=model/resnet18_SQTWN_s3_iter_300000.caffemodel
