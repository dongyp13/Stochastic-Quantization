...
$TOOLS/caffe train \
	...
	--weights=model/alexnet_SQTWN_s1_iter_200000.caffemodel

$TOOLS/caffe train \
	--solver=solver_s3.prototxt -gpu 0 \
	--weights=model/alexnet_SQTWN_s2_iter_200000.caffemodel

$TOOLS/caffe train \
	--solver=solver_s4.prototxt -gpu 0 \
	--weights=model/alexnet_SQTWN_s3_iter_200000.caffemodel
