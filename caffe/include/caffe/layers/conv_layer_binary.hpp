#ifndef CAFFE_CONV_LAYER_BINARY_HPP_
#define CAFFE_CONV_LAYER_BINARY_HPP_
...
class BinaryConvolutionLayer : public BaseConvolutionLayer<Dtype> {
 public:
  ...
  /* setup ternary convolution layer specific parameters and variables
     Yinpeng Dong date: 1/14/2017
  */
 ...
 protected:
  ...
  Blob<Dtype> alpha_; // scaling factors
...
#endif  // CAFFE_CONV_LAYER_BINARY_HPP_
