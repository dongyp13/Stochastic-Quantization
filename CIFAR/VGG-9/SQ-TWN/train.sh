...
$TOOLS/caffe train \
	...
	--weights=model/cifar_vgg9_SQTWN_s1_iter_100000.caffemodel

$TOOLS/caffe train \
    --solver=solver_s3.prototxt -gpu 0 \
	--weights=model/cifar_vgg9_SQTWN_s2_iter_100000.caffemodel

$TOOLS/caffe train \
    --solver=solver_s4.prototxt -gpu 0 \
	--weights=model/cifar_vgg9_SQTWN_s3_iter_100000.caffemodel
